...
public class battlesystem : MonoBehaviour
{
    ...
    void Start()
    {
        FindObjectOfType<SoundManager>().StopPlaying("vac");
        FindObjectOfType<SoundManager>().StopPlaying("lev1mus");
    ...
    void EndBattle()
    {
        ...
        if(state == BattleState.WON)
        {
            ...
            dialogueText.text = "YOU DID IT! YOU WIN A TRIP TO FUNLAND!!-Art by Sheenu. Programming by Kalpa and Sheenu. 2019";
